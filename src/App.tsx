...
export default function App(props: {
    ...
    return (
        <div
            className={`min-h-screen font-sans transition-colors duration-700 ease-in-out ${theme === "dark" ? "bg-slate-950 text-white" : "bg-slate-50 text-slate-900"} relative overflow-hidden flex flex-col items-center justify-between p-6 m-0`}
        >
                    ...
                    {props.openTerminal && (
                        <div className="flex flex-col items-center gap-4 order-2 lg:order-3 lg:col-span-2 w-full">
                            <div className="relative group/btn">
                                <div
                                    className={`absolute -inset-0.5 rounded-2xl blur opacity-40 group-hover/btn:opacity-100 transition duration-1000 group-hover/btn:duration-200 animate-tilt ${theme === "dark" ? "bg-gradient-to-r from-fs-blue-400 to-fs-blue-700" : "bg-gradient-to-r from-fs-blue-500 to-fs-blue-800"}`}
                                ></div>
                                <button
                                    ...
                                    onClick={() =>
                                        props.openTerminal(dontShowAgain)
                                    }
                                >
                                    <svg
                                        className={`w-6 h-6 shrink-0 transition-transform duration-300 group-hover/btn:scale-110 ${theme === "dark" ? "text-fs-blue-400" : "text-white"}`}
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                    >
